...
def get_all_deaths_by_state_over_time(start_date,end_date):
    if(not valid_date(start_date)):
    ...
    for state in states:
        ...
        row = [state]
        for date in dates:
            deaths_dict = get_state_death_data(state,date)
...
if __name__ == '__main__':
    ...
    get_all_deaths_by_district_over_time(start_date,end_date)
